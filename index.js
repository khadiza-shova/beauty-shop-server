...
const uri = `mongodb+srv://${process.env.DB_NAME}:${process.env.DB_PASS}@cluster0.qjq5l6y.mongodb.net/?retryWrites=true&w=majority`;
...
// Cart Product Post
  ...
  app.get("/cart",async(req,res)=>{
    const query = cartProductCollection.find();
    const result = await query.toArray();
    res.send(result);
  })
